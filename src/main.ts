...
// const createCashoutLimiter = rateLimit({
//   windowMs: 60 * 1000, // 1 minute window
//   max: 5, // start blocking after 5 request
//   message:
//     "Too many requests created from this IP, please try again after 60 seconds"
// });
...
async function bootstrap() {
  ...
  const app = await NestFactory.create(AppModule);
  // RateLimit the cashout api
  // app.use("/core/cashoutmoneylink", createCashoutLimiter);
